...
この文書では、*yacc って何？　美味しいの？　みたいなプログラマ、そうオレをターゲットに、
ステップバイステップで yacc の使い方* について学んでいく。
...
大雑把に言えばプログラミング言語みたいな一定のルールを守った言語のことを
「 [形式言語](https://ja.wikipedia.org/wiki/%E5%BD%A2%E5%BC%8F%E8%A8%80%E8%AA%9E) 」と呼びます。
